...
OneButton button[] = {
    OneButton(BTN_LEFT, true, BTN_INTERNALPULLUP),
    OneButton(BTN_CENTER, true, BTN_INTERNALPULLUP),
    OneButton(BTN_RIGHT, true, BTN_INTERNALPULLUP),
    OneButton(ENC_BTNB, true, ENC_INTERNALPULLUP),
    OneButton(BTN_UP, true, BTN_INTERNALPULLUP),
    OneButton(BTN_DOWN, true, BTN_INTERNALPULLUP),
    OneButton(ENC2_BTNB, true, ENC2_INTERNALPULLUP),
    OneButton(BTN_MODE, true, BTN_INTERNALPULLUP)
};
